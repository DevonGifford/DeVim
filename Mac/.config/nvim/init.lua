...
-- Resize windows
keymap.set("n", "<leader><Right>", ":exe 'vertical resize ' .. (winwidth(0) * 3/2)<CR>", { silent = true, desc = "Widen split" })
keymap.set("n", "<leader><Left>",  ":exe 'vertical resize ' .. (winwidth(0) * 2/3)<CR>", { silent = true, desc = "Narrow split" })
