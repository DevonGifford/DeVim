return {
    ...
    config = function()
        ...
        dapui.setup()
        vim.keymap.set("n", "<leader>dl", "<cmd>lua require('dapui').toggle()<CR>", {noremap = true, desc = "Toggle DAP UI"})
        ...
        vim.keymap.set("n", "<leader>ds", "<cmd>lua require('dap').step_over()<CR>", {noremap = true})
